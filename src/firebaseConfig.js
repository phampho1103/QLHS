...
import { getFirestore, collection,deleteDoc, setDoc,getDoc,deleteField, addDoc, getDocs ,query, where, collectionGroup, doc , updateDoc } from "firebase/firestore";
...
export { db, collection, addDoc, getDocs ,deleteDoc, query ,deleteField, where, collectionGroup , doc ,setDoc,getDoc, updateDoc };